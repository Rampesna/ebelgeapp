        ...
        <tr>
            <td align="center" valign="center" style="text-align:center; padding: 40px">
                <a href="http://ebelge.app" rel="noopener" target="_blank">
                    <img alt="Logo" src="{{ asset('assets/media/logos/bien.png') }}"
            ...
            <td align="left" valign="center">
                <div
                    ...
                    <div style="padding-bottom: 40px; text-align:center;">
                        <a href="{{ route('web.user.authentication.resetPassword', ['token' => $token]) }}" rel="noopener"
                    ...
                    <div style="padding-bottom: 50px; word-wrap: break-all;">
                        <p style="margin-bottom: 10px;">Buton çalışmıyor mu? Bu URL'yi tarayıcınıza yapıştırmayı
                            deneyin:</p>
                        <a href="{{ route('web.user.authentication.resetPassword', ['token' => $token]) }}" rel="noopener"
                           target="_blank" style="text-decoration:none;color: #009EF7">{{ route('web.user.authentication.resetPassword', ['token' => $token]) }}</a>
                    </div>
                    <!--end:Email content-->
        ...
        <tr>
            <td align="center" valign="center"
                ...
                <p>Tüm Hakları Saklıdır ©
                    <a href="https://www.bienteknoloji.com" rel="noopener" target="_blank">Bien Teknoloji A.Ş.</a>.</p>
            </td>
        </tr>
        </br>
</div>
