<div class="modal fade show" id="QuickActionsModal" aria-modal="true" role="dialog" data-bs-modal-backdrop-opacity="0.1">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content rounded" style="background: transparent; border: none; box-shadow: none">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a onclick="quickActionsNewCompany()" class="card py-0">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Yeni Cari</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a href="{{ route('web.user.invoice.create') }}" class="card py-0">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Yeni Fatura</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a onclick="quickActionsNewPayment()" class="card py-0">
                            <div class="card-body">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Yeni Ödeme</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a onclick="quickActionsNewCollection()" class="card py-0">
                            <div class="card-body">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Yeni Tahsilat</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a onclick="quickActionsNewEarn()" class="card py-0">
                            <div class="card-body">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Yeni Gelir</span>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-xl-12">
                        <a onclick="quickActionsNewExpense()" class="card py-0">
                            <div class="card-body">
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Yeni Gider</span>
                            </div>
                        </a>
                    </div>
                </div>
