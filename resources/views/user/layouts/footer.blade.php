    ...
    <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
        <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
            <div class="text-dark order-2 order-md-1">
                ...
                <a href="https://bienteknoloji.com.tr" target="_blank" class="text-gray-800 text-hover-primary">Bien Teknoloji A.Ş.</a>
            </div>
...
<div id="mobileFooter" style="display: none; margin-top: 75px">
    <div class="{{ auth()->user()->theme() == 1 ? 'mobileFooterDark' : 'mobileFooter' }} py-5 px-3">
        <div class="row h-50px">
            <a href="{{ route('web.user.dashboard.index') }}" class="col-3 text-dark text-center">
                <span class="svg-icon {{ request()->segment(1) == 'dashboard' ? 'svg-icon-primary' : '' }} svg-icon-2qx">
            ...
            <a href="{{ route('web.user.company.index') }}" class="col-2 text-dark text-center">
            ...
            <a href="{{ route('web.user.invoice.index') }}" class="col-2 text-dark">
            ...
            <a href="{{ route('web.user.transaction.index') }}" class="col-3 text-dark text-center">
