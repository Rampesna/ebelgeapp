                        ...
                        <div class="row">
                            <div class="col-xl-12 mb-5">
                                <div class="form-group position-relative">
                                    <label for="new_earn_safebox_id" class="d-flex align-items-center fs-6 fw-bold mb-2">
                                        <span class="required">Kasa & Banka</span>
                                    </label>
                                    <select id="new_earn_safebox_id" class="form-select form-select-solid select2Input" data-control="select2" data-placeholder="Kasa & Banka"></select>
                                </div>
                            </div>
                        </div>
                        <div class="row">
