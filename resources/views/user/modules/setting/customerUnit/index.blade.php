...
@section('content')
    ...
    @include('user.modules.setting.customerUnit.components.contextMenu')

    @include('user.modules.setting.customerUnit.modals.createCustomerUnit')
    @include('user.modules.setting.customerUnit.modals.updateCustomerUnit')
    @include('user.modules.setting.customerUnit.modals.deleteCustomerUnit')

    <div class="">
        <div class="row">
            <div class="col-xl-12 text-end">
                <button class="btn btn-primary" onclick="createCustomerUnit()">Yeni Birim</button>
            </div>
        </div>
        <br>
    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                <label for="filter_customer_unit_keyword" class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span>Ara</span>
                                </label>
                                <input id="filter_customer_unit_keyword" type="text" class="form-control form-control-solid filterInput" placeholder="Anahtar Kelime...">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tr class="text-start text-dark fw-bolder fs-7 gs-0">
                            <th class="">Birim Kodu</th>
                            <th class="">Birim Adı</th>
                            <th class="text-end">İşlemler</th>
                        </tr>
                        </thead>
                        <tbody class="fw-bold text-gray-600" id="customerUnits"></tbody>
                    </table>
                </div>
            </div>
        </div>
