...
@section('subheader')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Ürünler</h1>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                <label for="filter_product_keyword" class="d-flex align-items-center fs-6 fw-bold mb-2">
                                    <span>Ara</span>
                                </label>
                                <input id="filter_product_keyword" type="text" class="form-control form-control-solid filterInput" placeholder="Anahtar Kelime...">
                            </div>
                        </div>
                    </div>
                </div>
...
@section('customStyles')
    @include('user.modules.product.index.components.style')
@endsection

@section('customScripts')
    @include('user.modules.product.index.components.script')
@endsection
